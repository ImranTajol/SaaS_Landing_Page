    ...
    <section>
        <Element name='pricing'>
            <div className='container'>
                <div className='max-w-960 border-2 pricing-head_before relative auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
                    <h3 className='h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm'>
                        Flexible pricing for teams of wall sizes
                    </h3>
                    ...
                    {plans.map((plan,index) => (
                        <div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%-2px)]'>
                            ...
                            <div className={clsx('relative flex flex-col items-center', index === 1 ? 'pt-24':'pt-12')}>
                                <div className={clsx('small-2 rounded-20 relative z-2 mx-auto mb-6 border-2 px-4 py-1.2 uppercase', index === 1 ? 'border-p3 text-p3':'border-p1 text-p1')}>
                                    {plan.title}
                                </div>
                            ...
                            <div className={clsx('body-1 relative z-2 mb-10 w-full border-b-s2 pb-9 text-center text-p4', index === 1 && 'bprder-b')}>
                                {plan.caption}
                            </div>
