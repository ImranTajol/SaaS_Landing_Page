...
const Header = () => {
  ...
  return (
    <header className={clsx('fixed top-0 left-0 z-50 w-full py-10 transition-all duration-400 max-lg:py-4', hasScrolled && 'py-2 bg-black-100 backdrop-blur-[8px]')}>
        <div className='container flex h-14 items-center max-lg:px-5'>
            <a className='lg:hidden flex-1 cursor-pointer z-2'>
                <img src="/images/xora.svg" alt="logo" width={115} height={40}/>
            </a>
            ...
            <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0', isOpen ? 'max-lg:opacity-100' : 'max-lg:pointer-events-none')}>
                <div className='max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before'>
                    ...
                    <div className='lg:hidden block absolute top-1/2 lest-0 w-[960px] h-[380] translate-x-[-290px] -translate-y-1/2 rotate-90'>
                        <img src="/images/bg-outlines.svg" alt="outline" className='relative z-2' />
                        <img src="/images/bg-outlines-fill.png" alt="outline" className='absolute inset-0 mix-blend-soft-light opacity-5' />
